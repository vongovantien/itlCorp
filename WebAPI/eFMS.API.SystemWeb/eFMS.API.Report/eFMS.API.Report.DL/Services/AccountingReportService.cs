                        ...
                        using (SqlDataReader reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                ...
                                var item = new sp_GetDataExportAccountant
                                {
                                    ...
                                    VatAmountUsd = reader["VatAmountVnd"] == DBNull.Value ? 0 : (decimal?)reader["VatAmountVnd"],
                                    ...
                                    VatPartnerID = reader["VatPartnerID"] == DBNull.Value ? string.Empty : reader["CreditNo"].ToString(),
                                    PartnerId = reader["PartnerId"] == DBNull.Value ? string.Empty : reader["CreditNo"].ToString(),
