        ...
        public static IEnumerable<Client> GetClients(string[] redirectUris, int tokenLifetime, int slientRefreshToken)
        {
            return new List<Client>
            {
                new Client
                {
                    ...
                    AllowedCorsOrigins = new List<string> {"http://localhost:4200","http://test.efms.itlvn.com", "http://test.efms.itlvn.com/en/", "http://test.efms.itlvn.com/vi/", "http://test.api-efms.itlvn.com/Catalogue", "http://localhost:44361"},
