namespace eFMS.API.Catalogue.DL.Common
{
    public partial class CatalogueLanguageSub
    {
        ...
        public static readonly string MSG_PARTNER_SALEMAN_DEFAULT_SERVICE_NOT_FOUND = "MSG_PARTNER_SALEMAN_DEFAULT_SERVICE_NOT_FOUND";
        public static readonly string MSG_PARTNER_SALEMAN_DEFAULT_SERVICE_NOT_ALLOW_EMPTY = "MSG_PARTNER_SALEMAN_DEFAULT_SERVICE_NOT_ALLOW_EMPTY";
        public static readonly string MSG_PARTNER_SALEMAN_DEFAULT_OFFICE_NOT_FOUND = "MSG_PARTNER_SALEMAN_DEFAULT_OFFICE_NOT_FOUND";
        public static readonly string MSG_PARTNER_SALEMAN_DEFAULT_OFFICE_NOT_ALLOW_EMPTY = "MSG_PARTNER_SALEMAN_DEFAULT_OFFICE_NOT_ALLOW_EMPTY";
        ...
        public static readonly string MSG_CHARGE_TYPE_NOT_FOUND = "MSG_CHARGE_TYPE_NOTFOUND";
