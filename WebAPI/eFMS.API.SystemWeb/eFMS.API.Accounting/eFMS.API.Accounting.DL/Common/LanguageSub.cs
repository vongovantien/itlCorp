...
namespace eFMS.API.Accounting.DL.Common
{
    public partial class AccountingLanguageSub
    {
        ...
        public static readonly string MSG_VOUCHER_ID_HAD_PAYMENT = "MSG_VOUCHER_ID_HAD_PAYMENT";
        ...
        #region Accounting Invoice Payment
        public static readonly string MSG_INVOICENO_ACCOUNTING_PAYMENT_EMPTY = "MSG_INVOICENO_ACCOUNTING_PAYMENT_EMPTY";
        public static readonly string MSG_SERIENO_ACCOUNTING_PAYMENT_EMPTY = "MSG_SERIENO_ACCOUNTING_PAYMENT_EMPTY";
        public static readonly string MSG_PARTNER_ACCOUNTING_PAYMENT_EMPTY = "MSG_PARTNER_ACCOUNTING_PAYMENT_EMPTY";
        public static readonly string MSG_PAYMENT_AMOUNT_ACCOUNTING_PAYMENT_EMPTY = "MSG_PAYMENT_AMOUNT_ACCOUNTING_PAYMENT_EMPTY";
        public static readonly string MSG_PAYMENT_AMOUNT_ACCOUNTING_PAYMENT_MUST_BE_NUMBER = "MSG_PAYMENT_AMOUNT_ACCOUNTING_PAYMENT_MUST_BE_NUMBER";
        public static readonly string MSG_PAIDDATE_ACCOUNTING_PAYMENT_EMPTY = "MSG_PAIDDATE_ACCOUNTING_PAYMENT_EMPTY";
        public static readonly string MSG_PAIDDATE_ACCOUNTING_PAYMENT_INVALID = "MSG_PAIDDATE_ACCOUNTING_PAYMENT_INVALID";
        public static readonly string MSG_PAYMENT_TYPE_ACCOUNTING_PAYMENT_EMPTY = "MSG_PAYMENT_TYPE_ACCOUNTING_PAYMENT_EMPTY";
        public static readonly string MSG_PAYMENT_TYPE_ACCOUNTING_PAYMENT_INVALID = "MSG_PAYMENT_TYPE_ACCOUNTING_PAYMENT_INVALID";
        public static readonly string MSG_CURRENCY_ACCOUNTING_PAYMENT_EMPTY = "MSG_CURRENCY_ACCOUNTING_PAYMENT_EMPTY";
        public static readonly string MSG_PAYMENT_METHOD_ACCOUNTING_PAYMENT_INVALID = "MSG_PAYMENT_METHOD_ACCOUNTING_PAYMENT_INVALID";
        public static readonly string MSG_PAYMENT_METHOD_ACCOUNTING_PAYMENT_EMPTY = "MSG_PAYMENT_METHOD_ACCOUNTING_PAYMENT_EMPTY";
        public static readonly string MSG_EXCHANGE_RATE_ACCOUNTING_PAYMENT_INVALID = "MSG_EXCHANGE_RATE_ACCOUNTING_PAYMENT_INVALID";
        ...
        public static readonly string MSG_SETTLEMENT_HAD_SHIPMENT_PREPAID_NOT_ISSUED_DEBIT = "MSG_SETTLEMENT_HAD_SHIPMENT_PREPAID_NOT_ISSUED_DEBIT";
