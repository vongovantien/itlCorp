...
{
    public class AccountingAgencyPaymentExport : AccountingCustomerPaymentExport
    {
        ...
        public new List<AccountingAgencyPaymentExportDetail> receiptDetail;
    }

    public class AccountingAgencyPaymentExportDetail : AccountingReceiptDetail
    {
