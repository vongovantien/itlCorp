...
namespace eFMS.API.Accounting.DL.IService
{
    public interface IAcctAdvancePaymentService : IRepositoryBase<AcctAdvancePayment, AcctAdvancePaymentModel>
    {
        ...
        List<AcctAdvanceRequestModel> GetAdvancesOfShipment(string jobId, Guid hblId, string settlementCode = null);
        ...
        void UpdateStatusPaymentNotSettledOfAdvanceRequest(IQueryable<AcctAdvanceRequest> advRequestList);
        ...
        List<string> GetAdvanceNobyIDs(List<Guid> Ids); 
    }
}
