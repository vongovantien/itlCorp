...
namespace eFMS.API.ForPartner.DL.Service
{
    public class CurrencyExchangeService : RepositoryBase<CatCurrencyExchange, CatCurrencyExchangeModel>, ICurrencyExchangeService
    {
        ...
        public AmountSurchargeResult CalculatorAmountSurcharge(CsShipmentSurcharge surcharge, decimal kickBackExcRate)
        {
            ...
            {
                var amountLocal = CalculatorAmountAccountingByCurrency(surcharge, ForPartnerConstants.CURRENCY_LOCAL, kickBackExcRate);
            ...
            {
                var amountUsd = CalculatorAmountAccountingByCurrency(surcharge, ForPartnerConstants.CURRENCY_USD, kickBackExcRate);
