...
namespace API.Mobile.Common
{
    ...
    {
        public static User user = new User{ UserId = "User 1", Role = "CS", StaffId ="6789", Password = "123456" };
        public static List<Job> jobs = new List<Job> {
            new Job { UserId = user.UserId, Id = "AE1303/0022", MBL = "VPC/TAHAP18084318", PO_NO = "Q3-17-GH", CustomerName = "DONG HUNG INDUSTRIAL JOIN STOCK COMPANY", PlaceFrom = "AL Arish", PlaceTo = "Albani", EstimateDate = 0, AssignTime = DateTime.Now, NumberStage = 6, NumberStageFinish = 0, Warehouse = "Unilever VN - Củ Chi, KCN Tây Bắc Củ Chi, TP HCM", CBM = 2000, GW = 256789, Cont = "01X20'DC & 14X40'DC", CurrentDeadline = DateTime.Now.AddDays(3), CurrentStageStatus = StatusEnum.JobStatus.Processing},
            new Job { UserId = user.UserId, Id = "AE1303/0023", MBL = "VPC/TAHAP18084318", PO_NO = "Q3-17-GH", CustomerName = "DONG HUNG INDUSTRIAL JOIN STOCK COMPANY", PlaceFrom = "AL Arish", PlaceTo = "Albani", EstimateDate = 0, AssignTime = DateTime.Now.AddDays(-2), NumberStage = 0, NumberStageFinish = 0, Warehouse = "Unilever VN - Củ Chi, KCN Tây Bắc Củ Chi, TP HCM", CBM = 2000, GW = 256789, Cont = "01X20'DC & 14X40'DC", CurrentDeadline = DateTime.Now.AddHours(5), CurrentStageStatus = StatusEnum.JobStatus.NotStart},
            new Job { UserId = user.UserId, Id = "AE1303/0024", MBL = "VPC/TAHAP18084318", PO_NO = "Q3-17-GH", CustomerName = "DONG HUNG INDUSTRIAL JOIN STOCK COMPANY", PlaceFrom = "AL Arish", PlaceTo = "Albani", EstimateDate = 0, AssignTime = DateTime.Now.AddDays(-1), NumberStage = 0, NumberStageFinish = 0, Warehouse = "Unilever VN - Củ Chi, KCN Tây Bắc Củ Chi, TP HCM", CBM = 2000, GW = 256789, Cont = "01X20'DC & 14X40'DC", CurrentDeadline = DateTime.Now, CurrentStageStatus = StatusEnum.JobStatus.Overdued},
            new Job { UserId = user.UserId, Id = "AE1303/0025", MBL = "VPC/TAHAP18084318", PO_NO = "Q3-17-GH", CustomerName = "DONG HUNG INDUSTRIAL JOIN STOCK COMPANY", PlaceFrom = "AL Arish", PlaceTo = "Albani", EstimateDate = 0, AssignTime = DateTime.Now.AddHours(-1), NumberStage = 0, NumberStageFinish = 0, Warehouse = "Unilever VN - Củ Chi, KCN Tây Bắc Củ Chi, TP HCM", CBM = 2000, GW = 256789, Cont = "01X20'DC & 14X40'DC", CurrentDeadline = DateTime.Now.AddHours(2), CurrentStageStatus = StatusEnum.JobStatus.WillOverDue},
            new Job { UserId = user.UserId, Id = "AE1303/0026", MBL = "VPC/TAHAP18084319", PO_NO = "Q3-17-GH", CustomerName = "DONG HUNG INDUSTRIAL JOIN STOCK COMPANY", PlaceFrom = "AL Arish", PlaceTo = "Albani", EstimateDate = 0, AssignTime = DateTime.Now.AddHours(-1), NumberStage = 0, NumberStageFinish = 0, Warehouse = "Unilever VN - Củ Chi, KCN Tây Bắc Củ Chi, TP HCM", CBM = 2000, GW = 256789, Cont = "01X20'DC & 14X40'DC", CurrentDeadline = DateTime.Now.AddHours(3), CurrentStageStatus = StatusEnum.JobStatus.NotStart},
            new Job { UserId = user.UserId, Id = "AE1303/0027", MBL = "VPC/TAHAP18084319", PO_NO = "Q3-17-GH", CustomerName = "DONG HUNG INDUSTRIAL JOIN STOCK COMPANY", PlaceFrom = "AL Arish", PlaceTo = "Albani", EstimateDate = 0, AssignTime = DateTime.Now.AddHours(-1), NumberStage = 0, NumberStageFinish = 0, Warehouse = "Unilever VN - Củ Chi, KCN Tây Bắc Củ Chi, TP HCM", CBM = 2000, GW = 256789, Cont = "01X20'DC & 14X40'DC", CurrentDeadline = DateTime.Now.AddHours(5), CurrentStageStatus = StatusEnum.JobStatus.NotStart},
            new Job { UserId = user.UserId, Id = "AE1303/0028", MBL = "VPC/TAHAP18084319", PO_NO = "Q3-17-GH", CustomerName = "DONG HUNG INDUSTRIAL JOIN STOCK COMPANY", PlaceFrom = "AL Arish", PlaceTo = "Albani", EstimateDate = 0, AssignTime = DateTime.Now.AddHours(1), NumberStage = 0, NumberStageFinish = 0, Warehouse = "Unilever VN - Củ Chi, KCN Tây Bắc Củ Chi, TP HCM", CBM = 2000, GW = 256789, Cont = "01X20'DC & 14X40'DC", CurrentDeadline = DateTime.Now.AddHours(5), CurrentStageStatus = StatusEnum.JobStatus.NotStart},
            new Job { UserId = user.UserId, Id = "AE1303/0029", MBL = "VPC/TAHAP18084319", PO_NO = "Q3-17-GH", CustomerName = "DONG HUNG INDUSTRIAL JOIN STOCK COMPANY", PlaceFrom = "AL Arish", PlaceTo = "Albani", EstimateDate = 0, AssignTime = DateTime.Now.AddDays(-1), NumberStage = 0, NumberStageFinish = 0, Warehouse = "Unilever VN - Củ Chi, KCN Tây Bắc Củ Chi, TP HCM", CBM = 2000, GW = 256789, Cont = "01X20'DC & 14X40'DC", CurrentDeadline = DateTime.Now.AddHours(4), CurrentStageStatus = StatusEnum.JobStatus.Processing},
            new Job { UserId = user.UserId, Id = "AE1303/0030", MBL = "VPC/TAHAP18084319", PO_NO = "Q3-17-GH", CustomerName = "DONG HUNG INDUSTRIAL JOIN STOCK COMPANY", PlaceFrom = "AL Arish", PlaceTo = "Albani", EstimateDate = 0, AssignTime = DateTime.Now.AddDays(-1), NumberStage = 0, NumberStageFinish = 0, Warehouse = "Unilever VN - Củ Chi, KCN Tây Bắc Củ Chi, TP HCM", CBM = 2000, GW = 256789, Cont = "01X20'DC & 14X40'DC", CurrentDeadline = DateTime.Now.AddHours(1), CurrentStageStatus = StatusEnum.JobStatus.Finish}
        };
