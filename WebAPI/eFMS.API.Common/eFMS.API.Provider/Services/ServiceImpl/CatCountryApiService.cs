...
namespace eFMS.API.Provider.Services.ServiceImpl
{
    ...
    {
        public CatCountryApiService(HttpClient httpClient, IOptions<Settings.APIUrls> settings) : base(httpClient, settings, 1, nameof(APIUrls.CatelogueUrl))
        {
        }
        ...
        public async Task<List<CatCountryApiModel>> Getcountries()
        {
            ...
            return await GetApi<List<CatCountryApiModel>>(strUri);
        }
    }
}
