...
export class JobRepo {
    ...
    getListStageOfJob(jobId: string) {
        return this._api.get(`${this.baseApi}/api/${this.VERSION}/vi/OpsStageAssigned/GetBy`, { jobId: jobId });
    ...
    getDetailStageOfJob(stageId: string) {
        return this._api.get(`${this.baseApi}/api/${this.VERSION}/vi/OpsStageAssigned/${stageId}`);
    ...
    getListStageNotAssigned(jobId: string) {
        return this._api.get(`${this.baseApi}/api/${this.VERSION}/vi/OpsStageAssigned/GetNotAssigned`, { jobId: jobId });
    ...
    addStageToJob(jobId: string, body: any = {}) {
        return this._api.put(`${this.baseApi}/api/${this.VERSION}/vi/OpsStageAssigned/AddMultipleStage`, body, { jobId: jobId });
    ...
    updateStageToJob(body: any = {}) {
        return this._api.put(`${this.baseApi}/api/${this.VERSION}/vi/OpsStageAssigned/Update`, body);
