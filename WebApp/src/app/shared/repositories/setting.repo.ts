...
export class SettingRepo {
    ...
    getListFolderName(folderParent: string, body: any) {
        return this._api.post(`${environment.HOST.SETTING}/api/${this.VERSION}/vi/FileManagement/Get?folderName=${folderParent}`, body).pipe(
            map((data: any) => data)
        );
    }
}
