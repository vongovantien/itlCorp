...
export class DocumentationRepo {
    ...
    getInfoMailDebitInv(body: any, jobId: string){
        console.log(body)
        return this._api.post(`${environment.HOST.DOCUMENTATION}/api/${this.VERSION}/en-US/DocSendMail/getInfoMailDebitInvoice`, body, {jobId: jobId});  
    }
}
