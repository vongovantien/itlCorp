...
export class ReuseStrategy implements RouteReuseStrategy {
    private routes: { [routePath: string]: RouteStates } = {
        '/home/documentation/air-export': { max: 1, handles: {}, handleKeys: [] },
        '/home/documentation/air-import': { max: 1, handles: {}, handleKeys: [] },
        '/home/documentation/air-import/:jobId': { max: 1, handles: {}, handleKeys: [] },
        '/home/documentation/air-export/:jobId': { max: 1, handles: {}, handleKeys: [] },
