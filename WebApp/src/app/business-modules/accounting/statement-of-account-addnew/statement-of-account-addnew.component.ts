...
@Component({
  selector: 'app-statement-of-account-addnew',
  templateUrl: './statement-of-account-addnew.component.html',
  styleUrls: ['./statement-of-account-addnew.component.scss']
})
export class StatementOfAccountAddnewComponent implements OnInit {
