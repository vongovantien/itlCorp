...
import { AddCreditCombineToReceipt, AddDebitCombineToReceipt, IsCombineReceipt, ReceiptCombineActionTypes, RegistTypeReceipt, ResetInvoiceList } from '../store/actions';
...
export class DetailReceiptCombineComponent extends ARCustomerPaymentCreateReciptCombineComponent implements OnInit {
  ...
  updateGeneralReceipt(data: ReceiptModel[]) {
    ...
    dataGeneral.forEach((item: any) => {
      const dataPush = item;
      dataPush.partnerId = item.customerId;
