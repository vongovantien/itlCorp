...
export enum AdvancePaymentActionTypes {
    ...
    LOAD_ADVANCE_DETAIL_SUCCESS = '[AdvancePayment] Load Detail Success]'
};
...
export const LoadAdvanceDetailSuccess = createAction(AdvancePaymentActionTypes.LOAD_ADVANCE_DETAIL_SUCCESS, props<AdvancePayment>());
