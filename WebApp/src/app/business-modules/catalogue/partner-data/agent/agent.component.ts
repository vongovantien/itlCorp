...
export class AgentComponent implements OnInit {
  ...
  criteria: any = { partnerGroup: PartenrGroupEnum.AGENT };
  ...
  async onDelete(event) {
    console.log(event);
    if (event) {
      this.baseService.delete(this.api_menu.Catalogue.PartnerData.delete + this.agent.id).subscribe((response: any) => {
