...
import { PermissionCreateComponent } from '../../../system/permission/add/add-permission.component';
...
export class ShareSystemDetailPermissionComponent extends PermissionCreateComponent {
