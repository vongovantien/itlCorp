...
import { ShareBussinessCdNoteAddRemainingChargeSeaPopupComponent } from "../add-remaining-charge/add-remaining-charge.popup";
...
@Component({
    selector: 'cd-note-add-sea-popup',
    templateUrl: './add-cd-note.popup.html'
})
export class ShareBussinessCdNoteAddSeaPopupComponent extends PopupBase {
    ...
    @ViewChild(ShareBussinessCdNoteAddRemainingChargeSeaPopupComponent) addRemainChargePopup: ShareBussinessCdNoteAddRemainingChargeSeaPopupComponent;
