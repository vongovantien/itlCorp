...
@Component({
    selector: 'cd-note-detail-sea-popup',
    templateUrl: './detail-cd-note.popup.html'
})
export class ShareBussinessCdNoteDetailSeaPopupComponent extends PopupBase {
    ...
    @ViewChild(ShareBussinessCdNoteAddSeaPopupComponent) cdNoteEditPopupComponent: ShareBussinessCdNoteAddSeaPopupComponent;
