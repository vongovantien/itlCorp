...
import { ShareBussinessCdNoteAddSeaPopupComponent } from '../add-cd-note/add-cd-note.popup';
import { ShareBussinessCdNoteDetailSeaPopupComponent } from '../detail-cd-note/detail-cd-note.popup';
...
@Component({
    selector: 'cd-note-list-sea',
    templateUrl: './cd-note-list.component.html',
    styleUrls: ['./cd-note-list.component.scss']
})
export class ShareBussinessCdNoteListSeaComponent extends AppList {
    @ViewChild(ShareBussinessCdNoteAddSeaPopupComponent) cdNoteAddPopupComponent: ShareBussinessCdNoteAddSeaPopupComponent;
    ...
    @ViewChild(ShareBussinessCdNoteDetailSeaPopupComponent) cdNoteDetailPopupComponent: ShareBussinessCdNoteDetailSeaPopupComponent;
