...
export class ShareGoodsImportComponent extends PopupBase implements OnInit {
    ...
    chooseFile(file: Event) {
        ...
        this._docRepo.upLoadGoodsFile(file.target['files'], parentId, isHouseBill)
            .pipe(
                finalize(() => {
    ...
    downloadFile() {
        this._docRepo.downloadgoodsfileExcel()
