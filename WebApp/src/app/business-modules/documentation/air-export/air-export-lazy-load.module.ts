...
import { AirExportAttachFilesModule } from "./detail-job/attach-file/air-export-attach-file.module";
...
export const lazyModulesFClMap: ILazyModules = {
    ...
    AirExport_attachFile: () => import('./detail-job/attach-file/air-export-attach-file.module').then(m => AirExportAttachFilesModule)
};
