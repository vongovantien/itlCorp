...
@Component({
    selector: 'app-sea-lcl-export-bill-detail',
    templateUrl: './sea-lcl-export-bill-detail.component.html'
})
export class SeaLclExportBillDetailComponent extends AppList {
    housebills: any[] = [];
