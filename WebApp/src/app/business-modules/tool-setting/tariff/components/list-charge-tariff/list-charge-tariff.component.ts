...
export class TariffListChargeComponent extends AppList {
    ...
    ngOnInit(): void {
        this.headers = [
            { title: 'Charge Name', field: 'chargeName', sortable: true, dataType: CommonType.DATATYPE.LINK },
    ...
    viewDetailTariffCharge(tariffCharge: TariffCharge, index: number, action: CommonType.ACTION_FORM = CommonType.ACTION.UPDATE) {
