...
@Component({
    selector: 'ops-cd-note-add-remaining-charge',
    templateUrl: './ops-cd-note-add-remaining-charge.popup.html'
})
export class OpsCdNoteAddRemainingChargePopupComponent extends PopupBase {
